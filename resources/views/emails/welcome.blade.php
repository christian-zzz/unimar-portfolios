...
<head>
    ...
    <title>Bienvenido a Folium UNIMAR</title>
    <style>
        body {
...
<body>
    <div class="container">
        ...
        <p>
            Te damos la bienvenida a <strong>Folium</strong>, la plataforma oficial del Decanato de Humanidades de la Universidad de Margarita (UNIMAR) para la creación de portafolios interactivos para los estudiantes de la Carrera de Diseño Gráfico.
        </p>
        
        <p>
            La administración ha creado tu cuenta estudiantil. A continuación, se detallan tus credenciales temporales de acceso para ingresar a la plataforma y comenzar a maquetar tu portafolio:
        </p>
